...
source=("git+https://github.com/mikebrady/shairport-sync#commit=409397d35495")
sha1sums=(SKIP)
...
build() {
  ...
  ./configure --prefix=/usr --sysconfdir=/etc --with-alsa --with-pa \
    --with-avahi --with-pw --with-stdout --with-pipe --with-ssl=openssl \
